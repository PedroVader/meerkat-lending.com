      ...
      <div className="max-w-2xl mx-auto space-y-4">
        {[
          ...
          <button
            ...
            className={cn(
              "group w-full px-10 py-4Debug text-lg font-semibold rounded-full transition-all duration-100 transform hover:scale-100 flex items-center justify-between",
